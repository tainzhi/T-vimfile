...
local default_patterns = {
    ...
    -- 情况1: https://idart.mot.com/browse/IKSWV-158874
    -- 06-04 08:10:11.857  1774 23657 W CallbackCore: [ACbAdptor-2-FrameHandler::updateMetaItem] [frameNumber 105] already receive error buffer, ignore meta
    -- 06-04 08:10:11.857  1774 23657 I mtkcam-cb: [notifyErrors] input number=105 id=-1 error=3
    -- 06-04 08:10:11.857  1774 23657 I mtkcam-cb: [prepareCallbackErrors] request 105 pending error result
    -- 06-04 08:10:11.857  1774 23657 I CallbackCore: [ACbAdptor-2-FrameHandler::prepareErrorMetaIfPossible] [frameNumber 105], result error
    "engine错误|onCaptureFailed|E CameraFsm|E CameraDevice|W CameraDevice|E Camera3-Device|E CamX : [ERROR]|E CamX.*Buffer|E CamX.*TimedWait|E CamX.*not|CAM_ERR.*Unexpected state|CamX.*error|CamX.*Failure|CamX.*failed|CamxResultETimeout|E CHI|E CHI.*bad state|CAM_ERR|there might be a leak|failed to get buffer|Unable to.*buffer|E MtkCam|CameraService|CameraService_proxy|Camera3-Device|receive error buffer|notifyErrors|prepareCallbackErrors",
