...
local default_plugins = alwasys_plugins
if vim.g.vscode == nil then
   -- if not vscode, load non vscode plugins
   default_plugins = vim.list_extend(default_plugins, nonvscode_plugins)
else
   -- if vscode, load vscode plugins
   default_plugins = vim.list_extend(default_plugins, vscode_plugins)
end
